...
class SNECore_TestCaseold extends MediaWiki_TestCase{
	...
	*/
	...
	protected function prepareTestDb(){
		...
		$tbl = array('user', 'page', 'revision', 'text', 'categorylinks', 'page_restrictions', 'interwiki');
		// if mw version is 1.16 or higher the 'l10n_cache' tabel is needed 
		if ( 1 == version_compare( $wgVersion, '1.16', '>=' ))
		{
			$tbl[] = 'l10n_cache';
			$tbl[] = 'parsertest_l10n_cache';
			$tbl[] = 'parsertest_msg_resource';
		}
